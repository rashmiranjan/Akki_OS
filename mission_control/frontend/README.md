# AKKI OS Dashboard (`frontend/`)

This package is the **Next.js** web UI for the AKKI OS control room.

- Talks to the AKKI OS **backend** over HTTP (typically `http://localhost:8000`).
