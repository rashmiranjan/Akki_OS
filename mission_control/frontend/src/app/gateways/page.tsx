  ...
  return (
    <>
      <DashboardPageLayout
        ...
        title="Gateways"
        description="Manage AKKI gateway connections used by boards"
        headerActions={
        ...
        <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
          <GatewaysTable
            ...
            emptyState={{
              ...
              description:
                "Create your first gateway to connect boards and start managing your AKKI connections.",
      ...
      <ConfirmActionDialog
        ...
        description={
          <>
            This removes the gateway connection from AKKI OS. Boards
